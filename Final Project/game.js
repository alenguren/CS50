...
function generateCoins() {
  var newCoin = {
    x: Math.random() * (originalBackgroundWidth - 20), // Use originalBackgroundWidth instead of backgroundImage.width
...
function update() {
  ...
  var backgroundOffsetX = backgroundImageX % backgroundImage.width;
  ...
  ctx.drawImage(
    backgroundImage,
    backgroundOffsetX - backgroundImage.width,
    0,
    backgroundImage.width,
    backgroundImage.height
  );
